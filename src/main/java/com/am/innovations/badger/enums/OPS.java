...
public enum OPS implements BiFunction<ResponseEntity<GitRepoResponse[]>, BadgesConfiguration, String> {
	...
	GITHUB {
		...
		@Override
		public String apply(ResponseEntity<GitRepoResponse[]> t, BadgesConfiguration badgesConfiguration) {
	...
	CLONE {
		...
		public String apply(ResponseEntity<GitRepoResponse[]> t, BadgesConfiguration badgesConfiguration) {
			final StringBuilder stringBuilder = new StringBuilder();
			Arrays.stream(t.getBody()).forEach(repo -> {
				stringBuilder.append(replaceUserNameAndRepoName(badgesConfiguration.getGithub().getClone(), repo));
	...
	ALL {
		@Override
		public String apply(ResponseEntity<GitRepoResponse[]> t, BadgesConfiguration u) {
			final StringBuilder stringBuilder = new StringBuilder();
